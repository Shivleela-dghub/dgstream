            ...
            <div className="container py-24 lg:py-32">
                <div className="grid items-center gap-16 lg:grid-cols-2">
                    <div>
                        ...
                        {/* Heading */}
                        <h1
                            className="mt-10 text-[64px] leading-[0.95] tracking-tight text-slate-950"
                            style={clash}
                        >
                            Creative and
                            <br />
                            ...
                            <span className="relative inline-block ml-3">
                                ...
                                {/* Line under "under" */}
                                <span className="absolute left-0 bottom-[-12px] w-[180px] h-[3px] bg-[#C8FF00]" />
                            </span>
                            <br />
                            ...
                            <span className="relative inline-block">
                                ...
                                {/* Line under "one roof" */}
                                <span className="absolute left-0 bottom-[-12px] w-[280px] h-[3px] bg-[#C8FF00]" />
                            </span>
                        </h1>
