...
export const ReelCard = ({ reel }) => {
  ...
  return (
    ...
    >
      ...
      {isHover && (
        <div
          className="absolute z-[999] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)] bg-black"
          style={{
            width: POPUP_WIDTH,
            height: POPUP_HEIGHT,
            left: '50%',
  ...
  playsInline
  autoPlay 
  preload="auto" // 1. was "metadata"
  muted // 2. ADD this for autoplay to work
...
/>
          ...
          {/* Bottom Controls */}
          <div
            className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/70 to-transparent z-20 flex items-center justify-between"
            style={{ pointerEvents: 'auto' }} // allow clicks on buttons
          >
