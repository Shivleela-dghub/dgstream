...
function BlogDetailPage() {
    ...
    <>
      ...
      <main className="pt-24 pb-20 bg-background">
        <div className="container max-w-4xl pt-8">
          ...
          <div className="h-10 w-1/2 bg-muted rounded animate-pulse mb-8" />
  ...
  const buildContent = () => {
    let html = `<p>${blog.content}</p>`;  // intro paragraph
          ...
          {blog.coverImage && (
            <div className="container max-w-5xl mb-16">
              <motion.div
                ...
                className="aspect-[21/9] w-full rounded-3xl overflow-hidden shadow-premium"
              >
                <img
                  src={blog.coverImage}
                  alt={blog.title}
              ...
              <div className="hidden lg:block w-16 shrink-0">
                <div className="sticky top-32 flex flex-col gap-4 items-center">
                  ...
                  <button onClick={() => handleShare('linkedin')}
                    className="w-10 h-10 rounded-full bg-muted flex items-center justify-center hover:bg-[#0A66C2] hover:text-white transition-colors"
              ...
              <div className="flex-1">
                ...
                {blog.category && (
                  <div className="mt-12 pt-8 border-t border-border flex flex-wrap gap-2">
                    <span className="px-4 py-2 bg-muted rounded-full text-sm font-medium text-foreground">
                      #{blog.category}
                    </span>
                  </div>
                )}
        ...
        <section className={`py-24 text-white text-center ${bgAccentColor}`}>
          <div className="container max-w-3xl">
            ...
            <Button asChild size="lg"
              className="bg-white text-primary hover:bg-white/90 font-bold rounded-xl px-10 py-7 text-xl shadow-xl hover:-translate-y-1 transition-all">
